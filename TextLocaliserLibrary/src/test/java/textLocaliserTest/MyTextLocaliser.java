...
public static void main (String [] args) {
    ...
    System.out.println("Pleae enter the country format the file is in: (UK, US, DE)");
    ...
    String outputFile = outputFileLocation + "\\" + outputFileName;
	
	TextLocaliser MyConverter = new MyTextLocaliser();
	
	ArrayList<String> fileLines = new ArrayList<String>();
	try {
		File inputFile = new File(args[0]);			// not going to work
